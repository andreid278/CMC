...
public class BlockModelsSelector extends Block implements ITileEntityProvider {

	public BlockModelsSelector(Material materialIn) {
		super(materialIn);
		this.setCreativeTab(CMCCreativeTab.tab);
		this.setUnlocalizedName("selectorblock");
		this.setRegistryName(CMC.MODID + ":selectorblock");
